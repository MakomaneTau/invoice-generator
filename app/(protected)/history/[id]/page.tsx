  ...
  return (
    <main className="history-shell">
      ...
      <section className="history-detail">
        <div className="history-detail-heading"><div><span>Finalized invoice</span><h1>{entry.invoice.invoiceNumber}</h1><p>{entry.invoice.customer.companyName || entry.invoice.customer.displayName}</p></div><PdfDownloadButton draft={entry.invoice} sellerProfile={entry.sellerProfile} className="button button-primary" /></div>
