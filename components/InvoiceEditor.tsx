  ...
  return (
    <div className="editor-stack">
      ...
      <section className="form-card">
        ...
        <div className="form-grid two-columns">
          <label className="field">Contact / display name<input value={draft.customer.displayName} onChange={(event) => updateCustomer("displayName", event.target.value)} aria-invalid={Boolean(errors["customer.displayName"])} placeholder="Hype Nation" /><FieldError message={errors["customer.displayName"]} /></label>
          <label className="field">Registered company name<input value={draft.customer.companyName} onChange={(event) => updateCustomer("companyName", event.target.value)} aria-invalid={Boolean(errors["customer.companyName"])} placeholder="HYPENATION PTY LTD" /><FieldError message={errors["customer.companyName"]} /></label>
